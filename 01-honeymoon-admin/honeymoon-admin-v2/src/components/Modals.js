  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{background:'rgba(0,0,0,0.6)'}}>
      <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-10 w-full max-w-[420px] text-center relative">
        ...
        <h3 className="font-baskerville text-2xl text-[#1a1a1a] mb-2">Approve Vendor</h3>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{background:'rgba(0,0,0,0.6)'}}>
      <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-10 w-full max-w-[420px] text-center relative">
        <button onClick={onNo} className="absolute top-4 right-4 w-7 h-7 border border-gray-300 rounded-full flex items-center justify-center text-gray-400 text-sm">✕</button>
        <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center text-red-500 text-3xl mx-auto mb-4">✕</div>
        <h3 className="font-baskerville text-2xl text-[#1a1a1a] mb-2">Reject Vendor</h3>
        <p className="text-gray-500 text-sm mb-4">Are You Sure You Want To Reject This Vendor?</p>
        <textarea rows={3} placeholder="Enter reason for rejection..." className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#b89b6b] resize-none mb-6" />
        <div className="flex gap-4">
          <button onClick={onNo} className="flex-1 bg-gray-200 text-gray-700 py-3 rounded-full font-medium hover:bg-gray-300 transition-colors">Cancel</button>
          <button onClick={onYes} className="flex-1 bg-red-500 text-white py-3 rounded-full font-medium hover:bg-red-600 transition-colors">Reject</button>
        </div>
      </div>
    </div>
  );
