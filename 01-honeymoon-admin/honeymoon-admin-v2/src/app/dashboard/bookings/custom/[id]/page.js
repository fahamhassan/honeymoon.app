  ...
  return(
    <div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-[0_0_20px_rgba(0,0,0,0.05)] mb-5">
        <div className="flex items-start justify-between mb-5">
          <div className="flex gap-8 text-sm flex-wrap">
            <div><p className="text-gray-400 text-xs">Request ID:</p><p className="font-medium">#1234567890</p></div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-[0_0_20px_rgba(0,0,0,0.05)]">
        <h2 className="font-baskerville text-2xl text-[#1a1a1a] text-center mb-1">AI Recommendation</h2>
        <p className="text-gray-400 text-sm text-center mb-6">Most couples in the [User Defined Location] with 300 guests spend 7000 AED – 9000 AED or 8000 AED on average</p>
