            ...
            {paged.map(m=>(
              <tr key={m.id} className="border-b border-gray-50 hover:bg-[#fafaf8] transition-colors">
                ...
                <td className="py-3.5 px-3">
                  <Link href={`/dashboard/meeting-requests/${m.id}`} className="text-xs text-[#174a37] border border-[rgba(23,74,55,0.3)] px-3 py-1.5 rounded-lg hover:bg-[#f4ebd0] transition-colors">View</Link>
                </td>
              </tr>
            ))}
          </tbody>
