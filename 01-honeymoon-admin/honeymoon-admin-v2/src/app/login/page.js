      ...
      <div className="flex items-center gap-10 max-w-5xl w-full px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-10 w-full max-w-[420px] flex-shrink-0">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center border border-gray-200 rounded-xl px-4 py-3 bg-[#faf8f4] focus-within:border-[#b89b6b] transition-colors">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center border border-gray-200 rounded-xl px-4 py-3 bg-[#faf8f4] focus-within:border-[#b89b6b] transition-colors">
              ...
              <button onClick={() => setShow(!show)} className="text-gray-400 text-xs ml-2">{show ? '🙈' : '👁'}</button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/forgot-password" className="text-sm text-[#b89b6b] hover:underline font-medium">Forgot Password?</Link>
          </div>
