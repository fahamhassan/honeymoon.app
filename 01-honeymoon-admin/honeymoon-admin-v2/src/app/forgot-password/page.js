  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{background:'rgba(0,0,0,0.6)'}}>
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-[380px] text-center relative">
        <button onClick={onOk} className="absolute top-4 right-4 w-7 h-7 border border-gray-300 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-600 text-sm">✕</button>
          ...
          {step === 2 && (
            <>
              ...
              <div className="flex justify-end mb-6">
                <button className="text-sm text-[#b89b6b] hover:underline">Resend Code</button>
              </div>
              <button onClick={async () => {
                if (!code) return;
