...
const T={
  get access(){return typeof window!=='undefined'?localStorage.getItem('user_access_token'):null;},
  get refresh(){return typeof window!=='undefined'?localStorage.getItem('user_refresh_token'):null;},
  set(a,r){localStorage.setItem('user_access_token',a);localStorage.setItem('user_refresh_token',r);},
  clear(){['user_access_token','user_refresh_token','user_data'].forEach(k=>localStorage.removeItem(k));}
};
let _r=false,_q=[];
