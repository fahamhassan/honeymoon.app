    ...
    <div className="min-h-screen bg-[#f4ebd0]">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <div className="flex items-center gap-3 mb-6">
          <Link href="/reported-bookings" className="text-gray-400 hover:text-[#174a37] text-lg transition-colors">←</Link>
          <h1 className="font-baskerville text-3xl text-[#1a1a1a]">Reported Booking</h1>
        </div>
        <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)] mb-5">
          <div className="flex items-start justify-between mb-6 pb-4 border-b border-gray-100">
            ...
            <span className="text-xs px-3 py-1.5 rounded-full font-medium bg-amber-50 text-amber-700 border border-amber-200">Under Review</span>
          </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)]">
          <h2 className="font-baskerville text-xl text-[#1a1a1a] mb-4">Timeline</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-4">
                <div className={`w-3 h-3 rounded-full mt-1 flex-shrink-0 ${item.done ? 'bg-[#174a37]' : 'bg-gray-200'}`} />
                <div>
