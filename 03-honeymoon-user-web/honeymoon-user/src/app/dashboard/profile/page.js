  ...
  return (
    <div className="max-w-[900px]">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-baskerville text-[36px] text-[#1a1a1a]">My Profile</h1>
        ...
        <button onClick={() => setEditing(!editing)}
          className={`text-sm font-medium px-5 py-2.5 rounded-[10px] transition-colors ${
            editing
              ? 'bg-[#b89b6b] text-white hover:bg-[#a08860]'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-white rounded-2xl border border-[rgba(184,154,105,0.2)] p-6 shadow-[0_0_30px_rgba(0,0,0,0.04)] text-center">
            ...
            <p className="text-[#b89b6b] text-sm mt-0.5">Premium Member</p>
            <div className="mt-4 bg-[#f4ebd0] rounded-xl p-3 text-center">
            ...
            <button className="mt-4 w-full border border-[rgba(184,154,105,0.3)] text-[#b89b6b] text-xs font-medium py-2 rounded-[8px] hover:bg-[#f4ebd0] transition-colors">
              Change Photo
            </button>
          </div>

          <div className="bg-[#174a37] rounded-2xl p-5 shadow-[0_0_30px_rgba(0,0,0,0.04)]">
            <p className="text-white/60 text-xs uppercase tracking-wider mb-1">Plan</p>
            <p className="text-[#b89b6b] font-baskerville text-[22px]">Premium</p>
            <div className="flex flex-col gap-2 mt-4">
              {['Unlimited AI matches', 'Priority vendor access', 'Dedicated planner', 'Direct chat'].map(f => (
                <p key={f} className="text-white/70 text-xs flex items-center gap-2">
                  <span className="text-[#b89b6b]">✓</span> {f}
                </p>
              ))}
            </div>
          </div>
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col gap-5">
                ...
                <div key={key}>
                  ...
                  {editing
                    ? <input value={form[key]} onChange={e => setForm(f => ({ ...f, [key]: e.target.value }))}
                        className="w-full border border-[rgba(184,154,105,0.3)] rounded-[10px] px-4 py-2.5 text-sm text-[#1a1a1a] outline-none focus:border-[#b89b6b]" />
          ...
          <div className="bg-white rounded-2xl border border-[rgba(184,154,105,0.2)] p-6 shadow-[0_0_30px_rgba(0,0,0,0.04)]">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="border border-[rgba(184,154,105,0.3)] text-[#b89b6b] text-sm font-medium px-4 py-2 rounded-[8px] hover:bg-[#f4ebd0] transition-colors">
                Change Password
              </button>
            </div>
          </div>
