...
const imgs = {
  ...
  aiAssistant: `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23b89b6b"><text y="20" font-size="20">✨</text></svg>`,
  ...
  footerLogoIcon: "/logo-icon.png",
  footerLogoText: "/logo-text.png",
  footerArabic: "/logo-arabic.png",
    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 h-[88px] flex items-center px-10 justify-between transition-all duration-300 ${scrolled ? 'bg-[#174a37] shadow-[0_2px_20px_rgba(0,0,0,0.2)]' : 'bg-transparent'}`}>
      <Link href="/" className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <img src={imgs.logoArabic} alt="هني موون" className="h-[16px] w-auto mt-1" />
        </div>
      </Link>
      <div className="hidden lg:flex items-center gap-7">
        {navLinks.map((l, i) => (
          <Link key={l.label} href={l.href}
            className={`text-[14px] uppercase tracking-wide transition-colors hover:text-white ${i === 0 ? 'text-white font-bold' : 'text-white/80 font-normal'}`}>
            {l.label}
          </Link>
        ))}
      </div>
      <div className="flex items-center gap-5">
        <button className="hidden md:flex items-center gap-2 text-white text-[14px] uppercase">
          <img src={imgs.globe} alt="" className="w-[18px]" />
          Eng
        </button>
        <Link href="/login"
          className="border border-white/40 text-white text-[14px] uppercase px-5 py-2.5 rounded-[7.5px] hover:bg-white/10 transition-colors">
          Sign Up | Login
        </Link>
      </div>
    </nav>
          ...
          <div className="flex-1">
            ...
            <div className="border-b border-white/30 pb-3 mb-6">
              <input value={email} onChange={e => setEmail(e.target.value)}
                ...
                className="bg-transparent text-white text-[22px] w-full focus:outline-none placeholder-white/30" />
            </div>
  ...
  return (
    <div className="bg-white font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-start overflow-hidden">
        ...
        {/* AI badge */}
        <div className="absolute top-[100px] right-10 flex flex-col items-center">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-10 pt-[200px] pb-[120px]">
          ...
          <h1 className="font-baskerville text-[72px] leading-[80px] text-[#fff6e9] capitalize max-w-[820px] mb-8">
          ...
          <Link href="/signup"
            className="inline-flex items-center justify-center bg-[#fff6e9] text-black text-[18px] capitalize px-10 py-4 rounded-[7.5px] shadow-[1.5px_18.75px_37.5px_0px_rgba(85,57,19,0.3)] hover:bg-white transition-colors">
            Start AI Planning
          </Link>
          <div className="mt-14">
      ...
      {/* APP DOWNLOAD */}
      <section className="relative min-h-[699px] flex items-center overflow-hidden">
        <img src={imgs.appBg} alt="" className="absolute inset-0 w-full h-full object-cover" />
        <div className="relative z-10 max-w-7xl mx-auto px-10 w-full flex flex-col lg:flex-row items-center justify-between gap-12 py-20">
          <div className="max-w-[560px]">
            <h2 className="font-baskerville text-[60px] leading-[65px] text-[#b89b6b] capitalize mb-6">
            ...
            <div className="flex gap-4 flex-wrap">
              <button className="flex items-center gap-3 bg-white border-[1.4px] border-[#b89b6b] rounded-[8.4px] px-4 h-[56px] w-[168px] hover:bg-[#f4ebd0] transition-colors">
      ...
      {/* HOW IT WORKS */}
      <section className="relative min-h-[873px] overflow-hidden">
        <img src={imgs.howBg} alt="" className="absolute inset-0 w-full h-full object-cover" />
        <div className="relative z-10 max-w-7xl mx-auto px-10 py-[100px]">
          <div className="flex items-start justify-between mb-10 flex-wrap gap-4">
            <h2 className="font-baskerville text-[60px] leading-[48px] text-[#b89b6b] capitalize">How It Works</h2>
            <Link href="/signup" className="bg-[#b89b6b] text-white text-[18px] capitalize px-8 py-4 rounded-[10px] hover:bg-[#a08860] transition-colors">
              Try AI planning
            </Link>
          </div>
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            <div className="w-full lg:w-[387px] h-[545px] rounded-t-[500px] overflow-hidden shadow-[0px_5px_20px_0px_rgba(0,0,0,0.05)] flex-shrink-0">
            ...
            <div className="flex-1">
              ...
              <div className="w-full h-[332px] overflow-hidden shadow-[0px_5px_20px_0px_rgba(0,0,0,0.05)] mt-2">
      ...
      <section className="relative min-h-[1103px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-10 py-[100px]">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h2 className="font-baskerville text-[60px] leading-[48px] text-[#b89b6b] capitalize">Vendor Categories</h2>
            ...
            <div className="absolute top-[100px] right-10">
              <Link href="/vendors" className="flex flex-col items-center justify-center w-[157px] h-[157px] rounded-full border border-[#b89b6b] hover:bg-[#b89b6b]/10 transition-colors">
                <p className="text-[#b89b6b] text-[14px] uppercase tracking-[1px] text-center leading-[18px]">View All<br/>Vendors</p>
                <span className="text-[#b89b6b] text-lg mt-2">→</span>
              </Link>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-16">
            {[
              ...
              <div key={cat.label} className="flex flex-col">
                <div className="relative rounded-t-[500px] overflow-hidden shadow-[0px_5px_20px_0px_rgba(0,0,0,0.05)]" style={{ height: 522 }}>
      ...
      <section className="relative min-h-[808px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-10 py-[120px]">
          <h2 className="font-baskerville text-[60px] leading-[48px] text-[#b89b6b] capitalize mb-12">Core Features</h2>
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="w-full lg:w-[437px] h-[481px] overflow-hidden shadow-[0px_5px_20px_0px_rgba(0,0,0,0.05)] flex-shrink-0">
              ...
              {['AI Shortlists', 'Real Availability', 'Smart Compare', 'Secure Payments', 'Direct Chat', 'Team Access'].map((f, i) => (
                <div key={f} className="border-b border-white/10 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <span className="text-[#b89b6b] text-sm">✦</span>
      ...
      {/* GALLERY */}
      <section className="bg-[#f4ebd0] py-[82px] overflow-hidden">
        <div className="max-w-7xl mx-auto px-10">
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="w-full lg:w-[550px] h-[668px] rounded-t-[500px] overflow-hidden shadow-[0px_5px_20px_0px_rgba(0,0,0,0.05)] flex-shrink-0">
              <img src={imgs.galleryArch} alt="" className="w-full h-full object-cover" />
            </div>
            <div className="flex-1 flex flex-col gap-6">
              <div className="flex items-start gap-4 flex-wrap">
                <div>
                  <p className="text-[#b89b6b] text-[20px] uppercase tracking-[4px]">GALLERY</p>
                  <h3 className="font-baskerville text-[60px] leading-[48px] text-[#b89b6b] uppercase mt-2">LATEST<br/>WEDDINGS</h3>
                </div>
                <div className="w-[256px] h-[440px] rounded-t-[500px] overflow-hidden shadow-[0px_5px_20px_0px_rgba(0,0,0,0.05)] ml-auto hidden lg:block">
                  <img src={imgs.gallerySmall} alt="" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="h-[332px] overflow-hidden shadow-[0px_5px_20px_0px_rgba(0,0,0,0.05)]">
      ...
      {/* TESTIMONIALS */}
      <section className="relative min-h-[714px] overflow-hidden">
        <img src={imgs.testimonialBg} alt="" className="absolute inset-0 w-full h-full object-cover" />
        <div className="relative z-10 max-w-7xl mx-auto px-10 py-[90px]">
          <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
            <h2 className="font-baskerville text-[60px] leading-[60px] text-[#b89b6b] uppercase max-w-[475px]">What Our Clients Have To Say</h2>
            <button className="bg-[#b89b6b] text-white text-[18px] capitalize px-8 py-4 rounded-[10px] hover:bg-[#a08860] transition-colors">View All Reviews</button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
            {[
              ...
              <div key={t.name + t.loc} className="bg-[#1a1a1a] border border-[#b89b6b]/50 p-10 min-h-[324px] flex flex-col justify-between">
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => <img key={i} src={imgs.star} alt="★" className="w-[14px] h-[14px] object-contain" />)}
                </div>
                <p className="text-white text-[20px] leading-[44px] flex-1">{t.quote}</p>
      ...
      {/* WAITLIST */}
      <section className="bg-[#174a37] min-h-[800px] relative overflow-hidden flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-10 py-[96px] w-full">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="bg-white rounded-[10px] p-10 w-full lg:w-[518px] flex-shrink-0">
                ...
                {[
                  ...
                  <div key={f.key}>
                    ...
                    <input value={form[f.key]} onChange={e => setForm(p => ({ ...p, [f.key]: e.target.value }))}
                      ...
                      className="w-full border border-[#d4d4d4] rounded-[10px] h-[48px] px-4 text-[16px] focus:outline-none focus:border-[#b89b6b]" />
                  </div>
                ))}
                <div>
                  ...
                  <textarea value={form.message} onChange={e => setForm(p => ({ ...p, message: e.target.value }))}
                    ...
                    className="w-full border border-[#d4d4d4] rounded-[10px] px-4 py-3 text-[14.4px] focus:outline-none focus:border-[#b89b6b] resize-none" />
                </div>
                <button className="relative h-[52px] rounded-[10px] overflow-hidden bg-[#174a37] text-white font-medium text-[16px] capitalize hover:bg-[#1a5c45] transition-colors">
                  Notify Me
                </button>
              </div>
            </div>
            <div className="flex-1 pt-4">
              <h2 className="font-baskerville text-[65px] leading-[80px] text-[#b89b6b] capitalize tracking-[-1.95px] mb-6">Join the waitlist</h2>
