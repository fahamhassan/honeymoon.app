...
const PLANS=[
  {id:1,name:'Subscription Name',price:'$100',period:'USD / Month',commissionDiscount:'10%',profileFeaturing:'N/A',bannerPromotion:'N/A'},
  {id:2,name:'Subscription Name',price:'$100',period:'USD / Month',commissionDiscount:'10%',profileFeaturing:'Available',bannerPromotion:'N/A'},
  {id:3,name:'Subscription Name',price:'$100',period:'USD / Month',commissionDiscount:'10%',profileFeaturing:'Available',bannerPromotion:'Available (Off Platform)'},
];
      ...
      <div className="bg-white rounded-2xl p-6 shadow-[0_0_20px_rgba(0,0,0,0.05)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {(plans.length ? plans : PLANS).map(p=>(
            <div key={p.id} className={`border-2 rounded-2xl p-6 transition-all ${p.id===currentPlan?'border-[#174a37] shadow-lg':'border-gray-100 hover:border-[rgba(184,154,105,0.3)]'}`}>
              ...
              <div className="bg-[#b89b6b] rounded-xl p-4 text-center mb-5">
