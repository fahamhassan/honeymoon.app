      ...
      <div className="bg-white rounded-2xl p-6 shadow-[0_0_20px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex items-center justify-between mt-5 pt-4 border-t border-gray-100">
          ...
          <div className="flex items-center gap-2">
            ...
            {[1,2,3].map(p=><button key={p} className={`w-9 h-9 rounded-xl text-sm font-medium ${p===1?'bg-[#174a37] text-white':'text-gray-500 hover:bg-[#f4ebd0]'} transition-colors`}>{p}</button>)}
