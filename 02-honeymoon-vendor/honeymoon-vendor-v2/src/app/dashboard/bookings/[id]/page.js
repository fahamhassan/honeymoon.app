      ...
      <div className="bg-white rounded-2xl p-6 shadow-[0_0_20px_rgba(0,0,0,0.05)]">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-5 text-sm">
              <div><p className="text-gray-400 text-xs">Name:</p><p className="font-medium text-gray-800">User ABC</p></div>
              <div><p className="text-gray-400 text-xs">Phone Number:</p><p className="font-medium text-gray-800">123456789</p></div>
        ...
        <div className="flex gap-3 mt-6 pt-5 border-t border-gray-100 flex-wrap">
          {status === 'Pending' && <>
            ...
            <button onClick={() => setModal('modify')} className="border border-[#174a37] text-[#174a37] px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[#f4ebd0] transition-colors">Modify & Approve ↗</button>
          </>}
          {status === 'Upcoming' && <>
